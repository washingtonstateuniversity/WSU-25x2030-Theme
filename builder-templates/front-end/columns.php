...
// Section label text - this value will be displayed as a header above the section columns.
$section_heading = ( isset( $ttfmake_section_data['label'] ) ) ? $ttfmake_section_data['label'] : '';
